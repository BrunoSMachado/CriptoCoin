...
sendButton.addEventListener('click', function(event) {
    ...
    Fabric_Client.newDefaultKeyValueStore({ path: store_path
    	...
    	var request = {
    		...
    		fcn: 'transaction',
    		args: ["MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQCcmtaOSBALW50YeLBL4JdQUDyIyFnXoHnM2SaOrREVJVvSERthaCdZKRkpGNDB5yBdENf+NI9KCSkBdVK5Zj0QR8GDMxGwwPZcnLDeT+tNxpSnPRneJ8vvpiXO3FlWsPOeVhg6Mtz+qernMs/MNC5eV8TImnu9i4Yg0TMFqBGWQQIDAQAB",address,amount]
    		chainId: 'mychannel',
    		txId: tx_id
    	};
